...
public class VarDec extends Command {
    ...
    public VarDec() {
        setUsage("&e/var dec <name> <value> &7 - Decrement global variable");
    }
    ...
    public void execute(CommandSender sender, String[] args) {
        if(args.length == 2) {
            try {
                ...
                sender.sendMessage(Colors.of("&aSuccessfully decremented global variable '"+name+"'. Current value: " + VariableManagerImpl.instance().getGlobal(name).value()));
