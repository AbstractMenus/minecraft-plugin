...
public class VarpDec extends Command {

    public VarpDec(){
        setUsage("&e/varp dec <player> <name> <value> &7 - Decrement personal variable");
    }
    ...
    public void execute(CommandSender sender, String[] args) {
        if(args.length == 3) {
            try {
                ...
                sender.sendMessage(Colors.of("&aSuccessfully decremented personal variable '"+name+"' for "+player+". Current value: " + VariableManagerImpl.instance().getPersonal(player, name).value()));
