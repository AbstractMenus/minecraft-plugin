...
public class ActionVarpMul implements Action {

    private final List<VarNumData> dataList;

    private ActionVarpMul(List<VarNumData> dataList) {
    ...
    public static class Serializer implements NodeSerializer<ActionVarpMul> {

        @Override
        public ActionVarpMul deserialize(Class type, ConfigNode node) throws NodeSerializeException {
            return new ActionVarpMul(node.getList(VarNumData.class));
        }
