...
public class ActionVarInc implements Action {

    private final List<VarNumData> dataList;

    private ActionVarInc(List<VarNumData> dataList) {
    ...
    public static class Serializer implements NodeSerializer<ActionVarInc> {

        @Override
        public ActionVarInc deserialize(Class type, ConfigNode node) throws NodeSerializeException {
            return new ActionVarInc(node.getList(VarNumData.class));
        }
