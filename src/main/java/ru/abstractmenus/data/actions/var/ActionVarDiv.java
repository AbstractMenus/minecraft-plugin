...
public class ActionVarDiv implements Action {

    private final List<VarNumData> dataList;

    private ActionVarDiv(List<VarNumData> dataList) {
    ...
    public static class Serializer implements NodeSerializer<ActionVarDiv> {

        @Override
        public ActionVarDiv deserialize(Class type, ConfigNode node) throws NodeSerializeException {
            return new ActionVarDiv(node.getList(VarNumData.class));
        }
