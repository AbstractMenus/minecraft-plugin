...
public class ActionVarpInc implements Action {

    private final List<VarNumData> dataList;

    private ActionVarpInc(List<VarNumData> dataList) {
    ...
    public static class Serializer implements NodeSerializer<ActionVarpInc> {

        @Override
        public ActionVarpInc deserialize(Class type, ConfigNode node) throws NodeSerializeException {
            return new ActionVarpInc(node.getList(VarNumData.class));
        }
